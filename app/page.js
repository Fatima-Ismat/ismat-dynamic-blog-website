    ...
    <main>
      <section className="container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center">
        ...
        <div className="w-full mt-4 lg:mt-0 lg:w-1/2">
          <Image src="https://www.creative-tim.com/twcomponents/svg/website-designer-bro-purple.svg" alt="purple" className="w-full h-full max-w-md mx-auto" 
          width={768} 
          height={512}/>
        </div>
      </section>
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          <Image src="/typescript.webp" className="w-full h-64 object-cover rounded-t-lg"
          alt="image"
          width={1024} 
          height={256}/>
          <div className="mt-4">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          <Image src="/blogging.jpg" alt="Blog 2" className="w-full h-64 object-cover rounded-t-lg"
          width={1024} 
          height={256}/>
          <div className="mt-4">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          <Image src="/blogging2.jpg" alt="Blog 3" className="w-full h-64 object-cover rounded-t-lg"
          width={1024} 
          height={256}/>
          <div className="mt-4">
